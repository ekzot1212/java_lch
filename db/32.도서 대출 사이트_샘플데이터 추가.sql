...
-- 500.ABC123 해리포터와 마법사의 돌 1 J.K 롤링저자/강동혁 엮은이 문학수첩, 일반도서
...
-- QWE123회원이 자바의 정석을 예약 했을 때 쿼리를 작성
...
UPDATE BOOK
SET BO_POSSIBLE_RESERVATION = (SELECT BS_NUM FROM BOOK_STATE WHERE BS_DESC = '예약 중')
