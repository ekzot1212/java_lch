...
public class ObjectEx {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println(pt1 == pt11);	//주소는 같지만 값은 다름
		...
		//주소가 다르지만
		System.out.println(pt2 == pt22);	//주소값이 같은지?
		//두 객체가 같다고 판별
		System.out.println(pt2.equals(pt22)); //내용이 같은지?
...
@Data	
//ShopManager를 equals()이용해서 코드짜면 더 단순화 가능함.
// 강사님 : equals() 는 반드시 기억해라..
...
class Point2 implements Cloneable{		// implements - 인터페이스를 상속받는,
	private int x, y;
